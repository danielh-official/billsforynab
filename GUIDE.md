...
> **Note**: Because of an issue with YNAB API, the only allowed frequencies are daily, weekly, monthly, and yearly. If you want to manage a bill with a different frequency, you'll have to work on its equivalent scheduled transaction in [YNAB](https://app.ynab.com).
